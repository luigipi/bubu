                ...
                <div class="col-lg-9">
                    <div class="content">
                        <div class="product_para_top">
                            <h4 class="title"><nuxt-link :to="'/product/'+productTitle">{{productTitle}}</nuxt-link></h4>
                        ...
                        <a v-b-toggle.offcanvas-add-cart class="add-to-cart offcanvas-toggle btn btn_sm theme-btn-one btn-black-overlay" title="Add To Cart">Add To Cart</a>
                    </div>
                </div>
            </div>
